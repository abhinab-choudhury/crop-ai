...
MODEL_CONFIGS = {
    'resnet9': {
        'pytorch_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet9_best.pth',
        'onnx_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet9_plant_disease.onnx'
    },
    'resnet18': {
        'pytorch_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet18_best.pth',
        'onnx_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet18_plant_disease.onnx'
    },
    'resnet50': {
        'pytorch_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet50_best.pth',
        'onnx_path': BASE_DIR / '..' / 'models' / 'plant-disease' / 'resnet50_plant_disease.onnx'
    }
}
